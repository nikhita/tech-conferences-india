...
| [Amazon AWS Summit](https://aws.amazon.com/summits/new_delhi/) | 12 May | JW Marriott Hotel Aerocity New Delhi | The AWS Summit brings together the cloud computing community to connect, collaborate and learn about AWS. In this action-packed, one-day event, you can choose from over 25 breakout sessions covering a broad range of topics and technical depth. Attend introductory sessions on new and existing AWS services or participate in sessions that go deep into architecture and code. All sessions will be delivered by subject matter experts from AWS, Partners or expert customers who can share their real world experiences and lessons learned.|
...
| Conference | Date | Venue | Description |
|------------|------|-------|-------------|
| [Mini-DebConf]](http://in2015.mini.debconf.org/)|30-31 January|Sauron, Gandalf and Isildur conference halls, Directiplex, Andheri (E), Mumbai|A mini-DebConf is an awesome opportunity for any user who wants to experience the magic of Free and Open Source Software (FOSS). Here you can meet the veterans in FOSS development, develop professional connections which will help you in future, chat with contributors who can guide you, advance the cause of Debian and most importantly, grasp the essence of FOSS development.|
