...
| [Oracle Code New Delhi](https://developer.oracle.com/code/newdelhi) | 09-10 May | Pragati Maidan New Delhi | Oracle Code is a free event for developers to learn about the latest developer technologies. |
...
| [Amazon AWS Summit](https://aws.amazon.com/summits/new_delhi/) | 12 May | JW Marriott Hotel Aerocity New Delhi | The AWS Summit brings together the cloud computing community to connect, collaborate and learn about AWS.|
...
| [Eclipse Summit India](https://eclipsesummit.in/) | 29 July | Infosys Campus, Electronic City, Bengaluru | This is a great opportunity for the Eclipse fraternity in India to learn, explore, share, and collaborate on the latest ideas and information about Eclipse ecosystem. |
...
| [Oracle Code Bengaluru ](https://developer.oracle.com/code/bangalore) | 10 August | No 1, Residency Road Bengaluru, Karnataka | Oracle Code is a free event for developers to learn about the latest developer technologies.|
| [DevOps++ Global Summit](https://www.townscript.com/e/devopsglobalsummitdoppa2017) | 9 Sept | Pune | It is a way to get the community together and experience the latest in DevOps and beyond.|
...
| Conference | Date | Venue | Description |
|------------|------|-------|-------------|
| [Mini-DebConf](http://in2015.mini.debconf.org/)|30-31 January|Sauron, Gandalf and Isildur conference halls, Directiplex, Andheri (E), Mumbai|A mini-DebConf is an awesome opportunity for any user who wants to experience the magic of Free and Open Source Software (FOSS).|
